...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha com.example.recetarium:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.recetarium:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines com.example.recetarium:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground com.example.recetarium:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.recetarium:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.example.recetarium:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor com.example.recetarium:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity com.example.recetarium:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior com.example.recetarium:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges com.example.recetarium:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge com.example.recetarium:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline com.example.recetarium:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.recetarium:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.recetarium:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.recetarium:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority com.example.recetarium:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts com.example.recetarium:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy com.example.recetarium:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout com.example.recetarium:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage com.example.recetarium:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery com.example.recetarium:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.recetarium:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.recetarium:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.recetarium:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.recetarium:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font com.example.recetarium:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle com.example.recetarium:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings com.example.recetarium:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight com.example.recetarium:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex com.example.recetarium:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.recetarium:font
     */
     ...
     * </table>
     *
     * @attr name com.example.recetarium:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.recetarium:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.recetarium:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.recetarium:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #zxing_camera_preview_zxing_framing_rect_height com.example.recetarium:zxing_framing_rect_height}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_camera_preview_zxing_framing_rect_width com.example.recetarium:zxing_framing_rect_width}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_camera_preview_zxing_preview_scaling_strategy com.example.recetarium:zxing_preview_scaling_strategy}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_camera_preview_zxing_use_texture_view com.example.recetarium:zxing_use_texture_view}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_framing_rect_height}
     ...
     * mm (millimeters).
     *
     * @attr name com.example.recetarium:zxing_framing_rect_height
     */
    public static final int zxing_camera_preview_zxing_framing_rect_height=0;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_framing_rect_width}
     * attribute's value can be found in the {@link #zxing_camera_preview} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.recetarium:zxing_framing_rect_width
     */
    public static final int zxing_camera_preview_zxing_framing_rect_width=1;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_preview_scaling_strategy}
     * attribute's value can be found in the {@link #zxing_camera_preview} array.
     *
     * <p>Must be one of the following constant values.</p>
     * <table>
     ...
     * </table>
     *
     * @attr name com.example.recetarium:zxing_preview_scaling_strategy
     */
    public static final int zxing_camera_preview_zxing_preview_scaling_strategy=2;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_use_texture_view}
     * attribute's value can be found in the {@link #zxing_camera_preview} array.
     *
     * <p>May be a boolean value, such as "<code>true</code>" or
     * "<code>false</code>".
     *
     * @attr name com.example.recetarium:zxing_use_texture_view
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #zxing_finder_zxing_possible_result_points com.example.recetarium:zxing_possible_result_points}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_finder_zxing_result_view com.example.recetarium:zxing_result_view}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_finder_zxing_viewfinder_laser com.example.recetarium:zxing_viewfinder_laser}</code></td><td></td></tr>
     * <tr><td><code>{@link #zxing_finder_zxing_viewfinder_mask com.example.recetarium:zxing_viewfinder_mask}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_possible_result_points}
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.example.recetarium:zxing_possible_result_points
     */
    public static final int zxing_finder_zxing_possible_result_points=0;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_result_view}
     * attribute's value can be found in the {@link #zxing_finder} array.
     *
     * <p>May be a color value, in the form of "<code>#<i>rgb</i></code>",
     * "<code>#<i>argb</i></code>", "<code>#<i>rrggbb</i></code>", or
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.example.recetarium:zxing_result_view
     */
    public static final int zxing_finder_zxing_result_view=1;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_viewfinder_laser}
     * attribute's value can be found in the {@link #zxing_finder} array.
     *
     * <p>May be a color value, in the form of "<code>#<i>rgb</i></code>",
     * "<code>#<i>argb</i></code>", "<code>#<i>rrggbb</i></code>", or
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.example.recetarium:zxing_viewfinder_laser
     */
    public static final int zxing_finder_zxing_viewfinder_laser=2;
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_viewfinder_mask}
     * attribute's value can be found in the {@link #zxing_finder} array.
     *
     * <p>May be a color value, in the form of "<code>#<i>rgb</i></code>",
     * "<code>#<i>argb</i></code>", "<code>#<i>rrggbb</i></code>", or
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.example.recetarium:zxing_viewfinder_mask
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #zxing_view_zxing_scanner_layout com.example.recetarium:zxing_scanner_layout}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link com.example.recetarium.R.attr#zxing_scanner_layout}
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.recetarium:zxing_scanner_layout
     */
